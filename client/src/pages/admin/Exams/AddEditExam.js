...
const AddEditExam = () => {
  ...
  const params = useParams(); // & The useParams hook is one of the several hooks in React router
          ...
          <Tabs defaultActiveKey="1">
            <TabPane tab="Exam Details" key="1">
              ...
              <div className="flex justify-end gap-2">
                ...
                <button className="parimary-outlined-btn" type="button"
                  onClick={() => navigate("/admin/exams")}
                >
                  Cancel
                </button>

                <button className="primary-content-btn" type="submit">
                  Save
                </button>
