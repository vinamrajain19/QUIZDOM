...
function AddEditQuestion({ showAddEditQuestionModal, setShowAddEditQuestionModal, refreshData, examId, selectedQuestion, setSelectedQuestion }) {
        ...
        <Modal
            ...
            <Form onFinish={onFinish} layout="vertical" initialValues={{
                ...
                <div className="flex justify-end mt-2 gap-3">
                    ...
                    <button className="primary-content-btn">Save</button>
                </div>
            </Form>
